...
INSERT INTO USER_SDO_GEOM_METADATA VALUES (
	'estates', 'geometry',
	SDO_DIM_ARRAY(SDO_DIM_ELEMENT('X', 0, 650, 0.1), SDO_DIM_ELEMENT('Y', 0, 650, 0.01)),
	NULL
);
...
INSERT INTO estates (id, geometry, valid_from, valid_to) VALUES(
	    1,
	    SDO_GEOMETRY(2003, NULL, NULL,
		    SDO_ELEM_INFO_ARRAY(1, 1003, 1),
		    SDO_ORDINATE_ARRAY(0,0, 650,0, 650,150, 350,150, 350,100, 0,100, 0,0)
	    ),
	    TO_DATE('26-10-2016', 'dd-mm-yyyy'),
	    TO_DATE('26-10-2116', 'dd-mm-yyyy')
);
